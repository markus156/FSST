...
namespace vis1
{
  partial class VisForm3
  {
    ...
    void CreateOnlineCurveWin()
    {
      ...
      //_olc.SetY1Scale(false, -2, 2); 
      _olc.SetY2Scale(false, -50, 50);
      _olc.SetXScale(false, 10, 21); 
      
      ph.ivs[0] = _olc.SetCurve2(0, "FG1", Color.Red, false, T_SAMPLE);
      ph.ivs[1] = _olc.SetCurve2(1, "FG2", Color.Blue, false, T_SAMPLE);
      // ph.ivs[2] = _olc.SetCurve2(2, "Z", Color.Green, false, T_SAMPLE);
      // ph.ivs[5] = _olc.SetCurve2(5, "pos", Color.Red, false, T_SAMPLE);
      // ph.ivs[6] = _olc.SetCurve2(6, "diff", Color.Blue, true, T_SAMPLE);
